...
*  联系：281829389（qq）
        ...
        http://www.nmtree.com
**************************************************************/
define('nmtree/toolTip/1.2.1/toolTip',function(require, exports, module){
    'use strict';
    require('toolTip.css');
    ;(function($) {
        'use strict';
        $.toolTip = function(elements, options) {

            var defaults = {

                animation_speed:    150,            //  The speed (in milliseconds) of the animation used to show/hide tooltips.
                                                    //
                                                    //  Default is 250

                animation_offset:   0,             //  The number of pixels the tooltips should use to "slide" into position.
                                                    //
            ...
            plugin.hide = function(elements, destroy) {
                ...
                elements.each(function() {
                    ...
                    if (tooltip_info) {
                        ...
                        $element.data('toolTip', tooltip_info);
            ...
            var _init = function() {
                ...
                $(window).bind('scroll resize', function(event) {
                    ...
                    elements.each(function() {
                        ...
                        // get a reference to the attached tooltip and its components
                        var tooltip_info = $(this).data('toolTip');
                        ...
                        if (tooltip_info) {
                            ...
                            // cache updated tooltip data
                            $(this).data('toolTip', tooltip_info);
    		...
    		var _create_tooltip = function($element) {
                ...
                if (!tooltip_info.tooltip) {
                    ...
                    tooltip_info = $.extend($element.data('toolTip'), tooltip_info);
                ...
                if (tooltip_info.window_resized || tooltip_info.window_scrolled) {
                    ...
                    tooltip_info.arrow_container.removeClass('toolTip_Arrow_Top');
                    tooltip_info.arrow_container.addClass('toolTip_Arrow_Bottom');
                    ...
                    if (
                        ...
                        tooltip_info.arrow_container.removeClass('toolTip_Arrow_Bottom');
                        tooltip_info.arrow_container.addClass('toolTip_Arrow_Top');
                ...
                if (!tooltip_info.sticky) {
                    ...
                    tooltip_info.hide_timeout = setTimeout(function() {
                        ...
                        if (tooltip_info.tooltip) {
                            ...
                            $('a.toolTip_Close', tooltip_info.tooltip).remove();
    ...
    //对外暴露接口
    module.exports = {
        Tip: function (elements) {
            return new $.toolTip(elements);
        },
        TipB: function(elements) {
            return new $.toolTip(elements,{
                'default_position' : 'below'
            });
        },
        TipL: function (elements) {
            return new $.toolTip(elements,{
                'position' : 'left'
            });
        },
        TipR: function (elements) {
            return new $.toolTip(elements,{
                'position' : 'right'
            });
        }
